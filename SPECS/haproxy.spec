...
Source0:        %{url}/download/%{VER_MINOR}/src/haproxy-%{VER_MINOR}.%{VER_PATCH}.tar.gz
...
%{__make} %{?_smp_mflags} CPU="generic" TARGET="linux-glibc" USE_OPENSSL=1 USE_PCRE2=1 USE_SLZ=1 USE_LUA=1 USE_CRYPT_H=1 USE_LINUX_TPROXY=1 USE_GETADDRINFO=1 USE_PROMEX=1 ${regparm_opts} ADDINC="%{build_cflags}" ADDLIB="%{build_ldflags}"
...
%changelog
* Sun Sep 28 2025 Chihyeon Lee <cutlets3254@dotguin.com> - 3.2.5-1
- initial packaging
